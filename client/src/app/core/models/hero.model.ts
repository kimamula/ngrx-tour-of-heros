  ...
  return [
    {
      ...
      'character': {
        ...
        'description': 'Bitten by a radioactive spider, high school student Peter Parker gained the speed,' +
          ' strength and powers of a spider.' +
    ...
    },
    {
      ...
      'character': {
        ...
        'urls': [
          ...
          {
            'type': 'comiclink',
            'url': 'http://marvel.com/comics/characters/1010338/captain_marvel_carol_danvers' +
              '?utm_campaign=apiRef&utm_source=e412b613dc219df8468f501f5524c190'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      'character': {
        'id': 1009664,
        'name': 'Thor',
        'description': 'As the Norse God of thunder and lightning, Thor wields one of the greatest weapons ever made,' +
          ' the enchanted hammer Mjolnir. While others have described Thor as an over-muscled, oafish imbecile,' +
          ' he\'s quite smart and compassionate.  He\'s self-assured, and he would never, ever stop fighting for a worthwhile cause.',
    ...
    },
    {
      ...
      'character': {
        ...
        'description': 'Wounded, captured and forced to build a weapon by his enemies,' +
          ' billionaire industrialist Tony Stark instead created an advanced suit of armor to save his life and escape captivity.' +
